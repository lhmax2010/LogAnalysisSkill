...
from symbol_audit import SPECS
...
def run(repo_root: Path) -> int:
    ...
    inventory = {spec.name: spec.owner for spec in SPECS}
    if len(inventory) != len(SPECS):
    ...
    print(
        f"SUMMARY | {ok} OK | {missing_inventory} MISSING_FROM_INVENTORY | "
